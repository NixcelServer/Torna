...
<br />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body text-center">
                                <a href="/unapprovedorgcount">
                                <h3 class="card-title text-white">Unapproved Exhibition Count</h3>
                                </a>
                                <h1>1</h1> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body text-center">
                                <a href="/unapprovedorgcount">
                                <h3 class="card-title text-white">Approved Exhibition Count</h3>
                                </a>
                                <h1>1</h1> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-title text-white">Rejected Exhibition Count</h3>
                                </a>
                                <h1>1</h1> 
                            </div>
                        </div>
