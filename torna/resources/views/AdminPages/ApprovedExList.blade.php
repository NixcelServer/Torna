        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-header text-center" style="background-color: #c2c2c2; font-family: Arial, sans-serif; font-size: 18px;  font-weight: bold;">Approved Exhibitor List</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($companies as $key => $exhibitor)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
            ...
            {{-- <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create Exhibition</h4>
                        <br/>
                        <div class="basic-form">
                            <form>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Exhibition Name</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Exhibition Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">From Date</label>
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control">
                                    </div>
                                    <label class="col-sm-2 col-form-label text-black">To Date</label>
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Start Time</label>
                                    <div class="col-sm-3">
                                        <input type="time" class="form-control">
                                    </div>
                                    <label class="col-sm-2 col-form-label text-black">End Time</label>
                                    <div class="col-sm-3">
                                        <input type="time" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Venue</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Venue">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Organized By</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Organized By">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Upload Company Logo</label>
                                    <div class="col-sm-3">
                                        <input type="file" class="form-control-file">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Active Status</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-dark">Create Exhibition</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                <h4 class="card-title">Welcome To NixcelSoft</h4>
                                <p>Please Enter User Details for further disccusion</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- <div class="col-lg-12">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <br/>
                        <div class="basic-form justify-content-center">
                            <form>
                                <div class="form-group row justify-content-center">
                                    <label class="col-sm-2 col-form-label text-black">Name</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Name">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-center">
                                    <label class="col-sm-2 col-form-label text-black">Email Id</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Email Id">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-center">
                                    <label class="col-sm-2 col-form-label text-black">Contact No</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="Contact No">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-center">
                                    <label class="col-sm-2 col-form-label text-black">Interested Services</label>
                                    <div class="col-sm-3">
                                        <select class="form-control">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-black">Notify By</label>
                                    <div class="col-sm-3">
