                        ...
                        <div class="card">
                            <div class="card-header" style="background-color: #c2c2c2; color: black; font-family: Arial, sans-serif; font-size: 18px; font-weight: bold;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>Interested Exhibitors List</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            @if ($exhibition && $exhibition->participantDetails)
                                                @foreach ($exhibition->participantDetails as $participant)
                                                    <tr>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="4">No Exhibitors participated.</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
