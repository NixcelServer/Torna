                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button class="btn btn-sm btn-success view-document-btn" data-toggle="modal" data-target="#documentModal" data-document="{{ $upcomingEx->attach_document }}" title="Document">
