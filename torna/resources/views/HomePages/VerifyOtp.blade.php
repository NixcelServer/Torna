    ...
    <body>
        <div class="container" id="registrationContainer">
            <div class="form-container">
                ...
                <form class="form-containerb" id="registrationForm" action="/verifyotppost" method="POST">
                    @csrf
                    <input type="hidden" name="email" id="otpEmail" value="{{ $email }}">
                    <input type="number" name="otp" id="otpInput" placeholder="Enter OTP" required style="width: 200px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 10px;">
                    <button type="submit" id="verifyBtn" required style="width: 200px;">Verify</button>
                </form>
